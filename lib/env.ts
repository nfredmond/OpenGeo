...
const serverSchema = z.object({
  ...
  TIPPECANOE_BIN: z.string().optional().default("tippecanoe"),
  PMTILES_GENERATOR_URL: z.string().optional().default(""),
  PMTILES_GENERATOR_TOKEN: z.string().optional().default(""),
  ODM_API_URL: z.string().optional().default(""),
  ODM_API_TOKEN: z.string().optional().default(""),
  OPENGEO_EXTRACTOR: z.enum(["mock", "http"]).default("mock"),
  OPENGEO_EXTRACTOR_URL: z.string().optional().default(""),
  OPENGEO_EXTRACTOR_TOKEN: z.string().optional().default(""),
